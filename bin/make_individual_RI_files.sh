...
rmats="rMATS_"
RI="RI"
description="RI Events for DS-AML"
...
for file in $allRIoriginalFiles; do
    ...
    # old absolute path
    #    awk -f /Users/annedeslattesmays/Desktop/projects/post-rmats-single-run/bin/make_bed_ri.awk $file >> $bed_filename
    # new relative path
    gawk -f "$SCRIPT_DIR/make_bed_ri.awk" $file >> $bed_filename
