...
#
#  INPUT - one of the output files that is generated with the prepareRIfiles.sh script, RI.coordinates.matrix.txt
#
#
...
#    col 1  becomes col 4 - that is the unique identifer for the RI event is the name
