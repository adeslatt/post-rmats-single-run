...
#
#  INPUT - one of the output files that is generated with the prepareSEfiles.sh script, SE.coordinates.matrix.txt
#
#
...
#    col 8  becomes col 2 - that is the upstream start exon becomes the thick start
#    col 11 becomes col 3 - the downstream end coordinate becomes the thick end
#    col 1  becomes col 4 - that is the unique identifer for the SE event is the name
...
#    col 10 - the number of exons, for the SE event this is always 3
